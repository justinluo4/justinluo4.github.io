...
export default function Hero() {
  return (
 <section id="home" className="container flex flex-col md:flex-row items-center justify-center min-h-[calc(100vh-56px)] py-20 gap-12">
 ...
 <Button asChild size="lg" variant="outline">
 <Link href="/Justin_Luo_f2025_july.pdf" target="_blank">My Resume</Link>
 </Button>
 {/* <Button asChild size="lg" variant="outline">
